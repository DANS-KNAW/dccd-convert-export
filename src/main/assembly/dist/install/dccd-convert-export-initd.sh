#!/usr/bin/env bash
#  /etc/init.d/dccd-nl.knaw.dans.dccd.nl.knaw.dans.dccd.convert-export

# ***** FILL IN APPROPRIATE RUN-LEVELS, START-UP AND SHUTDOWN PRIORITIES !!! ******
# chkconfig: 2345 92 58

# Provides:          dccd-nl.knaw.dans.dccd.nl.knaw.dans.dccd.convert-export
# Short-Description: Starts the dccd-nl.knaw.dans.dccd.nl.knaw.dans.dccd.convert-export service
# Description:       This file is used to start the daemon
#                    and should be placed in /etc/init.d

NAME="dccd-nl.knaw.dans.dccd.convert-export"
EXEC="/usr/bin/jsvc"
APPHOME="/opt/dans.knaw.nl/$NAME"
JAVA_HOME="/usr/lib/jvm/jre"
CLASSPATH="$APPHOME/bin/$NAME.jar"
CLASS="nl.knaw.dans.easy.nl.knaw.dans.dccd.convert.ServiceStarter"
ARGS=""
USER="$NAME"
